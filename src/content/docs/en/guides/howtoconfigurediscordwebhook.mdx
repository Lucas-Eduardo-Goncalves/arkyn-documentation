...
<Aside type="note">
**Having trouble with permissions?** If you are unable to configure the bot's
permissions on the server, you can install the bot as an administrator
...
1. Access the [webhook creation endpoint](/api/en/api/webhook/createwebhook)
