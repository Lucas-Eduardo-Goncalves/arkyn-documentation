---
title: generateId
description: Generates a unique identifier (UUID) in the specified format and type.
---
...
### Example 1: Generate a v4 UUID as Text
...
### Example 2: Generate a v7 UUID as Binary
