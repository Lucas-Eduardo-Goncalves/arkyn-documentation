...
description: Formats a numeric value into a currency string based on the specified currency and setting.
---
...
### Example 1: Format to US Dollar (USD)
...
### Example 2: Format to Brazilian Real (BRL)
