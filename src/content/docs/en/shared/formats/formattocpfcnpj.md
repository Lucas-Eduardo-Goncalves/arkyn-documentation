...
description: Formats a string into the CPF or CNPJ format, depending on the length.
---
...
### Example 2: Formatting a CNPJ (National Taxpayer Registry)
...
### Example 3: Handling an Invalid Value
