...
description: Hides specific digits in a string within a given range.
---
...
### Example 1: Hide the First Digits (Default)
...
### Example 2: Hide a Specific Range with a Custom Character
...
### Example 3: Hide the Last Digits
