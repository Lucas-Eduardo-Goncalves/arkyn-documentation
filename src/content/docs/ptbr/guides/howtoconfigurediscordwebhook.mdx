---
title: Como configurar o webhook para o Discord
---
...
## Etapa 4: Crie o Webhook na API

1. Acesse o [endpoint de criação do webhook](/ptbr/api/webhook/createwebhook)

2. Use o ID do canal copiado na Etapa 2

3. Crie o bot com o ID do canal, escolhendo o tipo `discord`. O nível de severidade deverá ser `fatal`, `warning` ou `info`.
